...
xgettext *.php */*.php */*.php --copyright-holder='Activity Development Team' --package-name='GLPI - Activity plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
