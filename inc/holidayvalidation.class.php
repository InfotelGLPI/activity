...
class PluginActivityHolidayValidation extends CommonDBChild {
   ...
   function showForm($ID, $options = []) {
      ...
      if ($validator && $this->fields["status"] == PluginActivityCommonValidation::WAITING) {
         ...
         echo "<td class='center'>";
         echo "<div style='color:forestgreen'><i id='accept_holiday' class='question fa fa-check-circle-o fa-4x'></i><br>" . __('Accept holiday', 'activity') . "</div>";
         echo "<input type='hidden' name='accept_holiday' value='0'>";
         echo "</td>";
         echo "<td class='center'>";
         echo "<div style='color:darkred'><i id='refuse_holiday' class='question fa fa-times-circle-o fa-4x'></i><br>" . __('Refuse holiday', 'activity') . "</div>";
