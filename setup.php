...
//   $PLUGIN_HOOKS['display_cmenu']['activity'] = "plugin_activity_display_cmenu";
   ...
   if ($plugin->isActivated("activity")) {
      ...
      Plugin::registerClass('PluginActivityActivity_Item', ['addtabon' => 'User']);
      Plugin::registerClass('PluginActivityActivity', ['planning_types' => true,
      ]);
      array_push($CFG_GLPI['planning_add_types'], 'PluginActivityActivity');
      ...
      if (Session::getLoginUserID()) {
         ...
         $PLUGIN_HOOKS['pre_item_add']['activity'] = ['Ticket_User' => ['PluginActivityTicket',
                                                                        'afterAddUser'],
                                                      'TicketTask'  => ['PluginActivityTicketTask',
                                                                        'preTaskAdd']];
   ...
   $PLUGIN_HOOKS['display_planning']['activity']  = ['PluginActivityActivity'      => "displayPlanningItem",
                                                     'PluginActivityPublicHoliday' => "displayPlanningItem",
                                                     'PluginActivityHoliday'       => "displayPlanningItem"];
   $PLUGIN_HOOKS['planning_populate']['activity'] = ['PluginActivityActivity'      => "populatePlanning",
                                                     'PluginActivityPublicHoliday' => "populatePlanning",
